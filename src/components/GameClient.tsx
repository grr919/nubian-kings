...
export default function GameClient() {
  ...
  if (screen === "home") return (
    <main className="landing"><section className="panel titlePanel">
      ...
      <div className="routeLinks"><a href="/">All Game Levels</a><a href="/amateur">Amateur Game</a><a href="/master">Master Game</a><button className="textButton" onClick={() => setHelp(true)}>Beginner Rules</button></div><small>Core prototype · Special card effects are deferred</small>
