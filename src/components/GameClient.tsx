...
export default function GameClient() {
  ...
  if (screen === "home") return (
    <main className="landing"><section className="panel titlePanel">
      ...
      <div className="routeLinks"><a href="/amateur">Play Amateur Level</a><a href="/master">Play Master Level</a><button className="textButton" onClick={() => setHelp(true)}>Beginner Rules</button></div><small>Core prototype · Special card effects are deferred</small>
