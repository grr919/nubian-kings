...
export default function MasterClient() {
  ...
  if (screen === "home") return <main className="landing masterLanding"><section className="panel titlePanel">
    ...
    <div className="routeLinks"><a href="/">Beginner Game</a><a href="/amateur">Amateur Game</a><button className="textButton" onClick={() => setHelp(true)}>Master Rules</button></div>
